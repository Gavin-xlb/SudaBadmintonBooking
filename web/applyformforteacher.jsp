...
<body>
<form name="applyform" action="Controller.do?action=applyformforteacher" method="post" style="text-align: center" >
    <div>
        <h3>个人信息</h3>
        <br/>
        姓名：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="tea_name" readonly="readonly" value="${sessionScope.Teacher_Info.tname} "><br>
        身份证号：<input type="text" name="tea_idnumber" readonly="readonly" value="${sessionScope.Teacher_Info.tidnumber} "><br>
        工号：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="tea_no" readonly="readonly" value="${sessionScope.Teacher_Info.tno} "><br>
