...
@WebServlet("/Sys_ManagerFormAction.do")
public class Sys_ManagerFormAction extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Manager_Password_Info mpi=mpid.findManagerByWnoAndWrole(username,"院级管理员","校级管理员");
        String message;
